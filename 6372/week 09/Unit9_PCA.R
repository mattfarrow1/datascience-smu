...
# Let's attach the training set newAuto so we don't have to keep writing
# newAuto$
attach(newAuto)
...
# Note year is continuous in the data set but it may be helpful to convert to
# categorical. You just got to try and see. to get proportions that make sense
...
# Categorical predictors can suffer from "multicollinearity" as well. We can use
# previous graphics and table to see if the they are associated.
