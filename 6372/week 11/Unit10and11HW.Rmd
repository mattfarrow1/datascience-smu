...
As discussed in the analysis plan of live session, a common approach to streamline the analysis of 2x2 contingency tables is to run either a Fisher's Exact Test or a Chi-Square Test to answer the key hypothesis question at hand. The following is an example of how to do both. At this stage the format of `mymat` doesn't matter, the p-value will be the same regardless of how the rows and columns are situated.
...
```{r}
vit.c <- data.frame(
  Supp = rep(c("Placebo", "Vitamin C", "Placebo", "Vitamin C"), times = c(312, 168, 88, 232)),
