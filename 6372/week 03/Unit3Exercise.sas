data math;
* infile 'Y:\Databases\DataScience@SMU.dtBase2\Files.noindex\csv\4\MathACT.csv' dlm=',' firstobs=2;
infile 'Y:\Databases\DataScience@SMU.dtBase2\Files.noindex\csv\5\MathACT_2.csv' dlm="," firstobs=2;
...
will be better for it and you will soon figure out you can do a lot of different things. For those of you who do not have the time, the alternative is to take the summary statistics
