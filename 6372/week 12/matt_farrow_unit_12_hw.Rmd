...
$\qquad$ <span style="color: blue;">Holding all other variables equal, the odds of a 6-cylinder car having the same gas mileage as a 4-cylinder car are 24% less likely. For a 4-cylinder car, holding all other variables equal, the odds of increased fuel efficiency are 76% higher for a one-year newer car.</span>
...
$\qquad$ <span style="color: blue;">In both the 0.1 and 0.9 cutoff values, the predictions are worse. For 0.1, more values were classified as "High" and for 0.9, more values were classified as "Low" as compared to the original 0.5 cutoff.</span>
