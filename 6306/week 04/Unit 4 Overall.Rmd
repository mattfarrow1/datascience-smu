...
# plotting
data_long %>% 
  ggplot(aes(x = age, y = measurement, color = condition)) +
  geom_point()
...
data_long %>% 
  ...
  ggtitle("Age v. Measurement v. Condition")
...
```{r}
df <- data.frame(
  year = c(2018, 2018, 2018, 2018, 2019, 2019, 2019, 2019, 2020, 2020, 2020),
...
get_prices_df %>% ggplot(aes(x = date, y = adj_close)) +
  geom_line() +
  ggtitle("Adjusted Close")
get_prices_df %>% ggplot(aes(x = date, y = adj_volume)) +
  geom_col() +
  ggtitle("Adjusted Volume")
...
resultsGoodIndicator %>% ggplot(aes(x = topic, fill = topic)) +
  geom_bar()
