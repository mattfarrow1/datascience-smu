...
cars %>% ggplot(aes(x = Weight, y = MPG)) +
  geom_point() +
  ggtitle("LR Model: Weight vs MPG") +
...
cars %>% ggplot(aes(x = Weight, y = MPG)) +
  geom_point() +
  geom_line(data = cars, aes(x = Weight, y = preds, col = "red", size = 1)) +
...
cars %>% ggplot(aes(x = Weight, y = Horsepower)) +
  geom_point() # Increasing SD?
cars %>% ggplot(aes(x = Displacement, y = Horsepower)) +
  geom_point()
cars %>% ggplot(aes(x = Acceleration, y = Horsepower)) +
  geom_point()
...
cars %>% ggplot(aes(x = Acceleration, y = Horsepower)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ggtitle("LR Model: Acceleration vs Horsepower")
...
cars %>% ggplot(aes(x = Acceleration, y = Horsepower)) +
  geom_point() +
  geom_line(data = cars, aes(x = Acceleration, y = squared_preds, col = "red")) +
  ggtitle("LR Model: Acceleration + Acceleration^2 vs Horsepower") +
  scale_color_discrete(name = "Predicted")
...
cars %>% ggplot(aes(x = Acceleration, y = Horsepower)) +
  geom_point() +
  geom_line(data = cars, aes(x = Acceleration, y = cubed_preds, col = "red")) +
...
cars %>% ggplot(aes(x = Horsepower, y = MPG)) +
  geom_point() +
  geom_line(data = cars, aes(x = Horsepower, y = horse_preds, col = "red")) +
  ggtitle("LR Model: Horsepower + Horsepower^2 vs MPG") +
  scale_color_discrete(name = "Predicted")
...
cars %>% ggplot(aes(x = Horsepower, y = MPG)) +
  geom_point() +
  geom_line(data = cars, aes(x = Horsepower, y = horseCubed_preds, col = "red")) +
  ggtitle("LR Model: Horsepower + Horsepower^2 + Horsepower^3 vs MPG") +
  scale_color_discrete(name = "Predicted")
...
cars %>% ggplot(aes(x = Horsepower, y = MPG)) +
  ...
  ggtitle("LR Model: Horsepower + Horsepower^2 vs MPG") +
  scale_color_discrete(name = "Predicted") +
  geom_point(aes(x = 250, y = floor(horse250[1])), color = "blue", shape = "square", size = 3)
